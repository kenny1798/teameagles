...
function TeamActivity() {
  ...
  useEffect(() => {
    ...
    msmartAxios.post(`/api/msmart/manager/get/activity/${teamId}`, data, {
      headers: {
  ...
  const getData = async (e, value) => {
    ...
    await msmartAxios.post(`/api/msmart/manager/get/activity/${teamId}`, data, {
      headers: {
        accessToken: user.token
      }
    }).then((response) => {
          ...
          <div className='container'>
            ...
            <nav aria-label="Page navigation example">
              <ul className="pagination justify-content-center">
                <li className="page-item"><Link className="page-link" to={`/msmart/team/manage/${teamId}`} aria-disabled="true">Members</Link></li>
                <li className="page-item"><span className="page-link disabled">Activity</span></li>
              </ul>
            </nav>
